...
1. Hardcoded rules for common parts: engine oil, filters, brake pads, timing belt, and battery.
2. Configurable rules in application config or the database.
3. Later: model-based predictions using collected user data.
