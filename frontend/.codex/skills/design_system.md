...
For the first UI iteration, implement:
...
- add car details form;
- vehicle dashboard;
- parts forecast widget as read-only;
- history list and basic add forms;
- chat empty and non-empty states with mock replies;
- settings screen.

Analytics, notifications, full charts, photo upload, and voice input can be implemented after the base app shell is stable.
