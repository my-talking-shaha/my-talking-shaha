...
abstract final class PartsColors {
  ...
  static const badgeBackground = Color(0xFF4A3A17);
  static const badgeBorder = Color(0xFF8B6500);
  static const accent = Color(0xFFFFD08A);
  static const ok = Color(0xFFADB5FF);
